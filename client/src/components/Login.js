...
const configYahoo = {
    ...
    icon: () => <SvgIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style={{ fill: 'grey' }}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3386.34 3010.5" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd">
    ...
    className: 'regular',
    style: { width: '225px',  background: 'linear-gradient(267deg,#7934f7, 50%,#7282fb)', fontWeight: 'bold' },
    activeStyle: { border: '1px solid black', background: "#7282fb" }
};

const MyYahooLoginButton = createButton(configYahoo);
...
const configKakao = {
    ...
    />,
    className: 'regular',
    style: { width: '225px', background: '#fee100', color: 'black', fontWeight: 'bold' },
...
const configGoogle = {
    ...
    className: 'regular',
    style: {width: '225px', background: 'white', color: 'black', fontWeight: 'bold' },
    // style: { background: 'linear-gradient(267deg,#fee100, 50%,fee100)' },
...
const Login = () => {
    return (
        <div className={'regular'} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginTop: '200px' }}>
            <div>
                <a href="/auth/google"  >
                    <MyGoogleLoginButton />
                </a>
            ...
            <div>
                <MyYahooLoginButton onClick={() => alert("Hesllo")} />
            </div>
            <div>
                <MyKaKaoLoginButton onClick={() => alert("Hesllo")} />
            </div>
        </div>
    )
}
